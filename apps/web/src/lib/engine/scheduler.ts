...
export const scheduledJobs: ScheduleDefinition[] = [
  ...
  {
    name: "Budget optimization review",
    description: "Analyze spend efficiency across all campaigns. Identify overspending, underspending, and budget reallocation opportunities.",
    intervalHours: 12,
    family: "review",
  ...
  {
    name: "Campaign optimization pass",
    description: "Run optimization analysis on active campaigns: bid adjustments, keyword performance, audience refinement, ad copy improvements.",
    intervalHours: 24,
    family: "review",
